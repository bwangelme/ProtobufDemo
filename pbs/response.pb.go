...
type Response struct {
	...
	//	*Response_ArticleResponse
	//	*Response_MusicResponse
...
func (x *Response) GetArticleResponse() *ArticleResponse {
	if x, ok := x.GetPayload().(*Response_ArticleResponse); ok {
		return x.ArticleResponse
	}
	return nil
}

func (x *Response) GetMusicResponse() *MusicResponse {
	if x, ok := x.GetPayload().(*Response_MusicResponse); ok {
		return x.MusicResponse
	}
	return nil
}
...
type Response_ArticleResponse struct {
	ArticleResponse *ArticleResponse `protobuf:"bytes,2,opt,name=articleResponse,proto3,oneof"`
}

type Response_MusicResponse struct {
	MusicResponse *MusicResponse `protobuf:"bytes,3,opt,name=musicResponse,proto3,oneof"`
}

func (*Response_ArticleResponse) isResponse_Payload() {}

func (*Response_MusicResponse) isResponse_Payload() {}
...
func (x *ArticleResponse) GetDate() string {
	if x != nil {
		return x.Date
	}
	return ""
...
func (x *MusicResponse) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *MusicResponse) GetAuthor() string {
	if x != nil {
		return x.Author
	}
	return ""
...
func (x *MusicResponse) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_response_proto_rawDesc = []byte{
	...
	0x22, 0xac, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1f, 0x0a,
	...
	,
	...
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x53, 0x0a, 0x0f, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65,
	...
	0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x65, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x65, 0x22, 0x51, 0x0a, 0x0d, 0x4d, 0x75,
	0x73, 0x69, 0x63, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74,
	...
	0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0x07, 0x5a,
	0x05, 0x2e, 0x2f, 0x70, 0x62, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_response_proto_goTypes = []interface{}{
	...
	(*MusicResponse)(nil),   // 3: MusicResponse
}
var file_response_proto_depIdxs = []int32{
	1, // 0: Response.header:type_name -> Header
	2, // 1: Response.articleResponse:type_name -> ArticleResponse
	3, // 2: Response.musicResponse:type_name -> MusicResponse
...
func file_response_proto_init() {
	...
	file_response_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Response_ArticleResponse)(nil),
		(*Response_MusicResponse)(nil),
	}
	type x struct{}
